...
[[https://github.com/Dr-Nekoma][Dr. Nekoma]] and [[https://github.com/dont-rely-on-nulls][Don't Rely on Nulls]].  
...
deployment tools, including [[https://nixos.org/][Nix/NixOS]], [[https://devenv.sh/][devenv]] (for local development
environments), [[https://opentofu.org/][OpenTofu]], and [[https://github.com/terrateamio/terrateam][Terrateam]].
...
1. **Stage 1 – Bootstrap Infrastructure**  
...
2. **Stage 2 – Declarative Configuration (NixOS)**
...
Once infrastructure is provisioned, further management and updates are fully
handled through Nix.
...
#+begin_src shell
  ...
  # or 
  just deploy-mgc
  # or if you want to test deploys locally as well
  just deploy-qemu
#+end_src

This rebuilds and deploys the NixOS configuration to the target host(s),
replacing manual provisioning or ad-hoc scripts.
